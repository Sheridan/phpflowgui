var tabdropdown =
{
	...
	init:function(menuid)
	{
		...
		this.init_element(menuid, "span");
		this.init_element(menuid, "a");
	},

	init_element:function(menuid, element)
	{
		var menuitems=document.getElementById(menuid).getElementsByTagName(element);
		for (var i=0; i<menuitems.length; i++)
		{
			if (menuitems[i].getAttribute("rel"))
			{
				var relvalue=menuitems[i].getAttribute("rel");
				var eitem = document.getElementById(relvalue).getElementsByTagName("a")[0];
				document.getElementById(relvalue).firstlink = eitem ? eitem : document.getElementById(relvalue).getElementsByTagName("span")[0];
